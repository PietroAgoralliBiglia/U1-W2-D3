...
// Stampa l'oggetto eyeColor risultante
console.log(eyeColor);

/* ESERCIZIO 6
  Usa un while loop per calcolare la massa totale dell'equipaggio. Salvala in una variabile chiamata "crewMass".
*/
// Inizializza la variabile per la massa totale dell'equipaggio
let crewMass = 0;
...
// Condizioni per determinare la tipologia di carico
if (crewMass < 500) {
...
*/
for (let i = 0; i < starWarsCharacters.length; i++) {
  // Verifica se il gender è "n/a" e cambialo in "robot" se vero
